...
import { MPCodeData } from "../../../MinsPipeline/js/modules/mpCore";
...
```
     ...
     * @return 结果
     */
    every(checkFunc: (this: HTMLElement, index: number)=>boolean): boolean;
    /**执行所有data存储的方法 */
    executeAll(funcName: string): this;
    /**将UI元素绑定到一个数据属性上，并响应其广播
     * @param target 属性所在对象
     * @param propertyName 属性名称
     * @param template 绑定模板名称
     * @return 元素自身的引用
     */
    BindProperty(target: MPPrototype, propertyName: string, template: string, onapply: string|Function): this;
    /**取消元素绑定 */
    UnbindProperty(): this;
    /**更新选定的所有元素
     * @return 元素自身的引用
     ...
     * @return 元素自身的引用
     */
    MPLoadWidget(mpObject: MPPrototype, authority: 'fullControl'|'editable'|'readonly'): this;
    /**加载代码编辑器 */
    MPCodeEditor(mpData: MPData, codeData: MPCodeData, authority: 'fullControl'|'editable'|'readonly'):this;
    /**
